        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-200/80 dark:border-slate-800/80">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs font-medium">
              <li><Link to="/" className="hover:text-slate-950 dark:hover:text-white transition-colors">Home</Link></li>
              <li><Link to="/hackathons" className="hover:text-slate-950 dark:hover:text-white transition-colors">Hackathons</Link></li>
              <li><Link to="/projects" className="hover:text-slate-950 dark:hover:text-white transition-colors">Find Teams</Link></li>
              <li><Link to="/match-engine" className="hover:text-slate-950 dark:hover:text-white transition-colors">AI Match Engine</Link></li>
              <li><Link to="/mentors" className="hover:text-slate-950 dark:hover:text-white transition-colors">Mentors</Link></li>
              <li><Link to="/global-map" className="hover:text-slate-950 dark:hover:text-white transition-colors">Global Map</Link></li>
              <li><Link to="/leaderboard" className="hover:text-slate-950 dark:hover:text-white transition-colors">Leaderboard</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs font-medium">
              <li><Link to="/" className="hover:text-slate-950 dark:hover:text-white transition-colors">About Us</Link></li>
              <li><Link to="/" className="hover:text-slate-950 dark:hover:text-white transition-colors">Help Center / Support</Link></li>
              <li><Link to="/" className="hover:text-slate-950 dark:hover:text-white transition-colors">Contact Us</Link></li>
              <li><a href="https://discord.com" target="_blank" rel="noreferrer" className="hover:text-slate-950 dark:hover:text-white transition-colors">Discord Guild</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs font-medium mb-4">
              <li><Link to="/" className="hover:text-slate-950 dark:hover:text-white transition-colors">Privacy Policy</Link></li>
              <li><Link to="/" className="hover:text-slate-950 dark:hover:text-white transition-colors">Terms of Service</Link></li>
              <li><Link to="/" className="hover:text-slate-950 dark:hover:text-white transition-colors">Security Audit</Link></li>
            </ul>
